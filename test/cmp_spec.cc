...
TEST_CASE("Ascending order string comparison function", "cmp") {
  ...
  qsort((void*)strs, n, sizeof(char*), rd_cmp_str_asc);
...
TEST_CASE("Descending order string comparison function", "cmp") {
  ...
  qsort((void*)strs, n, sizeof(char*), rd_cmp_str_des);
...
TEST_CASE("Ascending order integer comparison function", "cmp") {
  ...
  qsort((void*)xs, n, sizeof(size_t), rd_cmp_sz_asc);
  REQUIRE(0 == xs[0]);
  REQUIRE(0 == xs[1]);
  REQUIRE(6 == xs[2]);
  REQUIRE(6 == xs[3]);
...
TEST_CASE("Descending order integer comparison function", "cmp") {
  ...
  qsort((void*)xs, n, sizeof(int8_t), rd_cmp_i8_des);
  REQUIRE(100 == xs[0]);
  REQUIRE(48 == xs[1]);
  REQUIRE(47 == xs[2]);
  REQUIRE(42 == xs[3]);
